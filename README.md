...
2. **Banco de Dados Duplo (Artigo 5º):** Usamos o PostgreSQL particionado. O container sobe contendo dois bancos de dados lógicos absolutamente isolados: `db_carteira` e `db_investimentos`. Nenhuma tabela compartilha *Foreign Keys* entre os microserviços.
...
*(Verbos PUT e DELETE funcionam nativamente para ambas as rotas enviando o ID na URL `/{id}/`)*.
